...
### <span style="color:darkred">Listas</span>
<br>
```{r echo=TRUE}
...
### <span style="color:darkred">Generación de muestras de distribuciones conocidas</span>
<br>
```{r echo=TRUE}
...
### <span style="color:darkred">Ejemplo IMCinfantil</span>
<br>
```{r echo=TRUE}
...
#install.packages("BiocManager")# como ya tengo el paquete instalado lo dejo comentado
library("BiocManager")# necesario para usar el paquete modeest
#BiocManager::install("genefilter")# necesario para usar el paquete modeest
#install.packages("modeest")# como ya tengo el paquete instalado lo dejo comentado
